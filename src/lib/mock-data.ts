...
export const TERAPIAS: { nome: TipoTerapia; cor: string; icone: LucideIcon }[] =
  [
    { nome: "Diálogo Fraterno", cor: "therapy-dialogo", icone: MessageSquare },
    { nome: "Reiki", cor: "therapy-reiki", icone: Hand },
    { nome: "Acupuntura", cor: "therapy-acupuntura", icone: Disc },
    { nome: "Barra de Access", cor: "therapy-barra", icone: Sparkles },
    { nome: "Meditação Guiada", cor: "therapy-meditacao", icone: User },
  ];
...
function criarSessoes(preenchidas: number): Sessao[] {
  return Array.from({ length: 10 }, (_, i) => ({
    ...
    data:
      i < preenchidas
        ? `2026-0${Math.min(i + 1, 2)}-${String((i + 1) * 7)
            .padStart(2, "0")
            .slice(0, 2)}`
        : null,
...
export const mockAtendimentos: Atendimento[] = [
  {
    ...
    terapeutaId: "2",
    tipoTerapia: "Reiki",
    sessoes: criarSessoes(4),
  },
  {
    id: "2",
    assistidoId: "1",
    terapeutaId: "2",
    tipoTerapia: "Diálogo Fraterno",
    sessoes: criarSessoes(1),
  },
  {
    id: "3",
    assistidoId: "2",
    terapeutaId: "3",
    tipoTerapia: "Acupuntura",
    sessoes: criarSessoes(6),
  },
  {
    id: "4",
    assistidoId: "3",
    terapeutaId: "2",
    tipoTerapia: "Barra de Access",
    sessoes: criarSessoes(2),
  },
  {
    id: "5",
    assistidoId: "5",
    terapeutaId: "3",
    tipoTerapia: "Meditação Guiada",
    sessoes: criarSessoes(3),
  },
];
...
export const mockAvaliacoes: Avaliacao[] = [
  {
    ...
    dataAvaliacao: "2026-02-15",
    observacoes: "Paciente relata melhora significativa.",
